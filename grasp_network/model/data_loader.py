...
class SDFDataset(Dataset):
    ...
    def __init__(self, data_dir):
        ...
        print(f"Opening Dataset from {filenames[0]}")
        ...
        self.grasp_queries_per_shape = self.examples[0][3].shape[0]

    def __len__(self):
        # return size of dataset
        
        return len(self.examples) * self.grasp_queries_per_shape
    ...
    def __getitem__(self, idx):
        ...
        """
        shape_idx = int(idx / self.grasp_queries_per_shape)
        grasp_idx = idx % self.grasp_queries_per_shape

        scan_pts, _, _, thetas, bs, qualities, _ = self.examples[shape_idx] # See description above.
        theta = thetas[grasp_idx]
        b = bs[grasp_idx]
        quality = qualities[grasp_idx]
