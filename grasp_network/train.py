...
parser.add_argument('--model_dir', default='experiments/sdf_cnn',
...
def train(model, optimizer, loss_fn, dataloader, metrics, params):
    ...
    # # Find evaluation metrics on the entire train dataset
    # metrics = evaluate(model, loss_fn, dataloader, metrics, params)
